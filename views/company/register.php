    ...
    <div class="login-container">
        <div class="login-card1">
            <div class="card-header">
                <h1 class="card-title">Pasang Iklan Lowongan<br>Kerja Gratis!</h1>
            ...
            <div class="login-body">
                <form action="auth-process.php" method="POST">
                    ...
                    <div class="form-group">
                        <input type="text" id="username" name="username" class="form-control" required placeholder="Nama Penanggung Jawab">
                    </div>
                    ...
                    <a href="google-auth.php" class="btn-google">
                        ...
                        <span class="btn-icon">
                            <img src="../../assets/img/icon-google2.png" alt="Google">
                        </span>
                    </a>

                    <!-- Agreement Text -->
                    <p class="agreement-text">
                        Dengan melanjutkan, anda menyetujui <a href="#">Perjanjian Pengguna</a>, <a href="#">Kebijakan Privasi</a> dan <a href="#">Syarat Ketentuan Layanan</a>
                    </p>

                    <!-- Daftar Button -->
                    <button type="submit" class="btn-daftar-primary">Daftar</button>
                </form>
